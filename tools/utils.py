...
#
#
# def log(obj, filename='log_moase.txt'):
#     print(obj)
...
#             if param.grad1 is not None:
#                 param.grad1.data.clamp_(-grad_clip, grad_clip)


def adjust_lr(optimizer, init_lr, epoch, decay_rate=0.1, decay_epoch=30):
    decay = decay_rate ** (epoch // decay_epoch)
    for param_group in optimizer.param_groups:
        # 最初是0.0005，前三十轮学习率保持不变，后面逐渐衰减,0.1是不断累积的，当epoch大于decay_epoch的时候
